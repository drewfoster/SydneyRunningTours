...
function theme_js() {
	...
	wp_register_script( 'theme-desktop_js', get_template_directory_uri() . '/js/theme-desktop.js', array('jquery'), '', true );
	if( wp_is_mobile() == false ) {
		wp_enqueue_script( 'theme-desktop_js' );
	}
